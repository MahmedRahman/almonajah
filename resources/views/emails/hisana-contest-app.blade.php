...
<head>
    ...
    <title>رابط تحميل تطبيق الحصانة</title>
</head>
                ...
                <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:560px;background:#ffffff;border-radius:16px;overflow:hidden;border:1px solid #ccfbf1;">
                    <tr>
                        <td style="background:linear-gradient(135deg,#0d9488,#0f766e);padding:24px 20px;text-align:center;color:#fff;">
                            <div style="font-size:20px;font-weight:700;margin-bottom:6px;">تطبيق الحصانة</div>
                            <div style="font-size:14px;opacity:.95;">مسابقة المناجاة</div>
                        </td>
                    </tr>
                    <tr>
                        <td style="padding:24px 22px;line-height:1.8;font-size:15px;">
                            <p style="margin:0 0 12px;">السلام عليكم{{ $name ? ' ' . e($name) : '' }}،</p>
                            <p style="margin:0 0 12px;">شكرًا لتسجيلك في مسابقة تطبيق <strong>الحصانة</strong>.</p>
                            ...
                            <p style="margin:16px 0 0;font-size:14px;color:#475569;">
                                مدة المسابقة شهر واحد، وتُعلن النتائج يوم {{ $resultsDate }} بإذن الله.<br>
