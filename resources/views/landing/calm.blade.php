...
<div class="calm-page">
    ...
    <div class="calm-hero">
        <h1>دعوة غيب</h1>
        <p class="ayah">«يا ابنَ آدم، إنك ما دعوتَني ورجوتَني غفرتُ لك على ما كان منك ولا أُبالي»</p>
        <p class="hadith-source">حديث قدسي — رواه الترمذي</p>
        <p class="lead">اكتب بما تشعر، نحلّل كلامك ونختار أقرب <strong>دعاء</strong> من أدعية منصة المناجاة — مكتوبًا وصوتيًا.</p>
    </div>
