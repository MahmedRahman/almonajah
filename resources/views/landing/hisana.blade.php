...
<div class="hisana-page">
    <div class="hisana-hero">
        ...
        <p class="intro">كتاب شامل يجمع أذكار المسلم الصحيحة من السنة النبوية،<br>مرتبة ومنظمة لتكون معك في يومك وليلَك، في صلاتك وسفرك، في فرحك وحزنك.</p>
    ...
    <div class="hisana-section">
        ...
        <p class="hisana-quote">«ألا بذكر الله تطمئن القلوب»</p>
    </div>
    ...
    <div class="hisana-section">
        <p class="hisana-section-title justify-content-center">✨ إصدار من مبادرة المناجاة</p>
        <p class="hisana-mission">عمل دعوي مجاني يهدف لنشر الخير وتيسير الذكر.<br>نسألكم الدعاء ونشر الكتاب لتعم الفائدة.</p>
    </div>
